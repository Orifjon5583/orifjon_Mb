const questionsSet1 = [
  ...
  },
  {
    ...
    options: [
      "admin",
      "user",
      "root", // To'g'ri variant
      "mysql_user",
    ],
    answer: "root", // Tushuntirish olib tashlandi
  },
  {
  ...
  {
    question:
      " MySQL da yangi ma'lumotlar bazasini yaratish sintaksisi qanday?",
    options: [
  ...
  {
    question:
      " Ham vaqt ham sanani saqlash uchun qanday ma'lumot turi ishlatiladi?",
    options: [
      "DATE",
      "TIME",
      "DATETIME", // To'g'ri variant
      "YEARONLY",
    ],
    answer: "DATETIME", // Tushuntirish olib tashlandi
  },
  {
    question:
      "Agar siz 1 dan 10 gacha bo'lgan sonlarni saqlamoqchi bo'lsangiz, qanday ma'lumot turini tanlasangiz eng optimal bo'ladi?",
    options: [
      "INT",
      "BIGINT",
      "TINYINT", // To'g'ri variant
      "VARCHAR(2)",
    ],
    answer: "TINYINT", // Tushuntirish olib tashlandi
  },
  {
    question:
      "Hisob kitob muhim bo'lganda (masalan pul birliklari) qanday ma'lumot turi aniqlik uchun ishlatilishi maslahat beriladi?",
    options: [
      "FLOAT",
      "DOUBLE",
      "DECIMAL", // To'g'ri variant
      "REAL",
    ],
    answer: "DECIMAL", // Tushuntirish olib tashlandi
  },
  {
    question:
      " Jadvalga yangi qator qo'shish uchun MySQL da qanday kalit so'z ishlatiladi?",
    options: ["ADD ROW", "INSERT INTO", "NEW RECORD", "PUT DATA"],
    answer: "INSERT INTO",
  },
  {
    question:
      " Jadvaldagi mavjud ma'lumotlarni o'zgartirish uchun MySQL tilida qanday kalit so'z ishlatiladi?",
    options: ["MODIFY", "CHANGE", "UPDATE", "ALTER RECORD"],
    answer: "UPDATE",
  },
  {
  ...
  {
    question:
      " Baza va Jadval yaratganda ularga nom berishda qaysi belgidan foydalanish odatda tavsiya etilmaydi (qo'shimcha belgilar bilan o'ralmasa)?",
    options: [
      "Lotin harflari (a-z, A-Z)",
      "Probel (bo'sh joy) va defis (-)", // To'g'ri variant
      "Pastki chiziq (_) va raqamlar (0-9)",
      "MySQL kalit so'zlari (masalan, SELECT, TABLE)",
    ],
    answer: "Probel (bo'sh joy) va defis (-)", // Tushuntirish olib tashlandi
  },
  {
  ...
  {
    question:
      " Faqat butun sonli ma'lumot turlari ko'rsatilgan qatorni tanlang.",
    options: [
  ...
  {
    question:
      " Faqat haqiqiy (kasr) sonli ma'lumot turlari ko'rsatilgan qatorni tanlang.",
    options: [
      "FLOAT, DOUBLE, INT",
  ...
  {
    question:
      " Faqat sana va/yoki vaqt ma'lumot turlari ko'rsatilgan qatorni tanlang.",
    options: [
      "DATE, TIME, VARCHAR",
  ...
  {
    question:
      " Katta hajmdagi matn (masalan, blog posti yoki maqola)ni saqlash uchun qaysi ma'lumot turi eng mos keladi?",
    options: [
      "VARCHAR(255)",
      "CHAR(1000)",
      "TEXT yoki LONGTEXT", // To'g'ri variant
      "BLOB",
    ],
    answer: "TEXT yoki LONGTEXT", // Tushuntirish olib tashlandi
  },
  {
    question:
      " Poyezdning kelish va ketish vaqtlarini (faqat soat va minut) saqlash uchun qanday ma'lumot turi maqsadga muvofiq?",
    options: ["TIME", "VARCHAR(5)", "INT", "DATE"],
    answer: "TIME",
  },
  {
    question:
      " Mahsulotlarning narxini (masalan, 12500.50 so'm) aniq saqlash uchun qaysi ma'lumot turi tavsiya etiladi?",
    options: [
      "INT",
      "VARCHAR(20)",
      "DECIMAL(10,2)", // To'g'ri variant
      "FLOAT",
    ],
    answer: "DECIMAL(10,2)", // Tushuntirish olib tashlandi
  },
  {
    question:
      " Foydalanuvchining 'rozilik berdi' (ha/yo'q) holatini saqlash uchun qaysi ma'lumot turi qulay?",
    options: [
      "VARCHAR(3)",
      "BOOLEAN (yoki TINYINT(1))", // To'g'ri variant
      "INT",
      "CHAR(1)",
    ],
    answer: "BOOLEAN (yoki TINYINT(1))", // Tushuntirish olib tashlandi
  },
  {
    question:
      "Passport seriyasi va raqamini (masalan, 'AB1234567') saqlash uchun qaysi ma'lumot turi mos keladi?",
    options: [
      "NUMERIC",
      "BIGINT",
      "VARCHAR yoki CHAR", // To'g'ri variant
      "TEXT",
    ],
    answer: "VARCHAR yoki CHAR", // Tushuntirish olib tashlandi
  },
  {
    question:
      " Mijozlar bilan rejalashtirilgan uchrashuvning aniq sana va vaqtini saqlash uchun qaysi ma'lumot turi ishlatiladi?",
    options: [
      "DATE",
      "INTERVAL",
      "DATETIME yoki TIMESTAMP", // To'g'ri variant
      "VARCHAR(50)",
    ],
    answer: "DATETIME yoki TIMESTAMP", // Tushuntirish olib tashlandi
  },
  {
    question:
      " Jadvalga yangi ma'lumot kiritish uchun to'g'ri SQL so'rovini toping:",
    options: [
  ...
  {
    question:
      "xodimlar jadvalidagi familiya ustuniga yangi qatorda 'Aminov' qiymatini kiritish so'rovini ko'rsating.",
    options: [
  ...
  {
    question:
      " Jadval ustuniga NOT NULL cheklovi qo'yilsa, bu nimani anglatadi?",
    options: [
  ...
  {
    question:
      " CRUD qisqartmasi ma'lumotlar bazasi operatsiyalarida nimani anglatadi?",
    options: [
  ...
  {
    question:
      " CRUDdagi 'Read' (o'qish) amali SQLda asosan qaysi operator yordamida bajariladi?",
  ...
  },
  {
    ...
    options: [
      ...
      "Jadvaldagi bir yoki bir nechta qatorlarni (ma'lumotlarni) o'chiradi.", // To'g'ri variant
      "Butun ma'lumotlar bazasini o'chiradi.",
      "Foydalanuvchining bazaga kirish huquqini o'chiradi.",
    ],
    answer:
      "Jadvaldagi bir yoki bir nechta qatorlarni (ma'lumotlarni) o'chiradi.", // Tushuntirish olib tashlandi
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      "Jadvaldan shartga mos keladigan bir yoki bir nechta qatorni (yozuvni) o'chirish.", // To'g'ri variant
      "Ma'lumotlar bazasidagi barcha jadvallarni o'chirish.",
      "Foydalanuvchi huquqlarini va sozlamalarini o'chirish.",
    ],
    answer:
      "Jadvaldan shartga mos keladigan bir yoki bir nechta qatorni (yozuvni) o'chirish.", // Tushuntirish olib tashlandi
  },
  {
  ...
  {
    question:
      " SELECT uchish_vaqti, joy_nomi FROM samolyotlar; so'rovi qanday natija beradi?",
    options: [
  ...
  {
    question:
      " WHERE bandining (clause) SQL so'rovlaridagi asosiy vazifasi nima?",
    options: [
  ...
  {
    question:
      " SQLda qiymatlarning teng emasligini tekshirish uchun qaysi operator(lar) ishlatiladi?",
    options: [
      "Tenglik uchun =",
      "Faqat !=",
      "Faqat <>",
      "Ham !=, ham <>", // To'g'ri variant
    ],
    answer: "Ham !=, ham <>", // Tushuntirish olib tashlandi
  },
  {
    question:
      " SELECT * FROM testlar WHERE t_javob = 'togri'; so'rovi qanday vazifani bajaradi?",
    options: [
  ...
  {
    question:
      " Quyidagi so'rovda xatolik bormi (agar javoblar ham ustun nomi bo'lsa)? SELECT javoblar FROM testlar WHERE t_javob = javoblar;",
    options: [
